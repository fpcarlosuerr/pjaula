...
urlpatterns = [
    ...
    path('instituicao/excluir/<int:id>/', login_required(views.excluir_instituicao), name='excluir_instituicao'),
    ...
    path('setor/alterar/<int:id>/', login_required(views.criar_setor), name='editar_setor'),
    path('setor/excluir/<int:id>/', login_required(views.excluir_setor), name='excluir_setor'),
    ...
    path('listarpessoas',views.abrir_lista_pessoas, name='listarpessoas'),
]
